...
public class ApplicationTest {
    ...
    @Test
    void testCheckout1() {
        Object[] rental = RentalData.getRentals()[0];
    ...
    @Test
    void testCheckout2() {
        Object[] rental = RentalData.getRentals()[1];
        Agreement agreement = checkout.checkout((String) rental[0], (int) rental[1], (int) rental[2], (LocalDate) rental[3]);
    ...
    @Test
    void testCheckout3() {
        Object[] rental = RentalData.getRentals()[2];
        Agreement agreement = checkout.checkout((String) rental[0], (int) rental[1], (int) rental[2], (LocalDate) rental[3]);
    ...
    @Test
    void testCheckout4() {
        Object[] rental = RentalData.getRentals()[3];
        Agreement agreement = checkout.checkout((String) rental[0], (int) rental[1], (int) rental[2], (LocalDate) rental[3]);
        Assertions.assertEquals(3, agreement.getChargeDays());
    ...
    @Test
    void testCheckout5() {
        Object[] rental = RentalData.getRentals()[4];
        Agreement agreement = checkout.checkout((String) rental[0], (int) rental[1], (int) rental[2], (LocalDate) rental[3]);
    ...
    @Test
    void testCheckout6() {
        Object[] rental = RentalData.getRentals()[5];
        Agreement agreement = checkout.checkout((String) rental[0], (int) rental[1], (int) rental[2], (LocalDate) rental[3]);
